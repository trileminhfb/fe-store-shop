<template>
  <div class="w-full h-screen bg-blue-300 flex justify-center items-center">
    <div
      class="w-[70vh] h-[50vh] bg-white flex flex-col justify-center items-center gap-5 rounded-3xl"
    >
      <div class="uppercase text-5xl font-extrabold italic">login</div>
      <input
        class="border rounded-3xl pl-3 h-10 w-80"
        type="text"
        name="account"
      ...
      <button
        class="uppercase font-bold rounded-2xl w-40 h-12 bg-blue-300 text-white"
        type="button"
        @click="handleLogin"
      >
        login
      ...
      <div class="flex flex-col items-center justify-center">
        <p>
          ...
          <router-link class="text-green-500" to="/register"
            >Sign up</router-link
          >
        </p>
        <p>
