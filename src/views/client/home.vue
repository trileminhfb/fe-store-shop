  ...
  <div class="w-full h-screen mt-32">
    ...
    <div class="overflow-hidden w-full h-[80vh] bg-black">
      <img
        ...
        src="https://www.foreverinfashion.org/articles/1.051739000.jpg"
        alt="Hero Image"
      />
    </div>
    ...
    <div
      class="mt-5 h-fit w-full flex flex-col justify-center items-center gap-5"
    >
    ...
    <div class="w-full h-[50vh] mt-5 p-10 bg-gray-300 flex flex-row">
      <div
        class="w-full h-full flex-1 justify-center items-center flex flex-col"
      >
      ...
      <div class="w-full h-full bg-red-100 flex-1 p-10 text-black">
        <div>
          ...
          <p>
            ...
            beatae molestiae illum, suscipit facere repellendus!
          </p>
        </div>
        <div class="mt-5">
