    ...
    <div class="w-[80vw] h-full flex justify-center items-center flex-row">
      <div class="flex-1 h-full flex justify-center items-center">
        <div class="h-[500px] w-[500px] bg-black overflow-hidden">
          ...
          <img :src="urlImg + product.image" alt="Product image" />
        </div>
      </div>
      <div
        class="flex-1 h-full flex flex-col text-black pt-20 pl-20 gap-5 text-2xl"
      >
        ...
        <div class="flex flex-row gap-5">
          <p>Quantity</p>
          <input
            class="border-black border text-end w-52 rounded-full pr-2"
            type="number"
            v-model="quantity"
            min="0"
        ...
        <div class="flex flex-row gap-5 items-center justify-center">
          <button
            class="flex-1 h-12 bg-orange-500 font-bold rounded-full"
            type="button"
            @click="goToBuyPage"
          >
            Buy
