<template>
    <div class="w-full h-fit flex flex-row justify-center items-center mt-32">
        <div class="w-[80vw] h-full flex justify-center items-start flex-row gap-2 mt-10">
            <!-- Account Information -->
            <div
                ...
                <div v-for="cart in carts"
                    ...
                    <img class="object-cover w-28 h-32" :src="'/images/products/' + cart.product.image"
                        alt="Product Image" />
            ...
            <!-- Product Information -->
            <div class="flex-1 rounded-xl h-fit flex flex-col text-black p-4 text-2xl border-black border">
                ...
                <div class="w-full flex justify-end">
                    <button
                        :class="'w-40 h-12 rounded-xl bg-orange-500 ' + (isLoading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer')"
                        :disabled="isLoading" type="button" @click="placeOrder()">
                        Place Order
                    </button>
